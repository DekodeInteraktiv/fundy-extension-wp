...
function Edit({
    ...
    _wordpress_api__WEBPACK_IMPORTED_MODULE_1___default().loadPromise.then(() => {
      ...
      if (false === isInitialized) {
        settings.fetch().then(response => {
          var _response$donations_o, _window$donationsSett;
          setState({
            apiToken: (_response$donations_o = response.donations_option_token) !== null && _response$donations_o !== void 0 ? _response$donations_o : '',
            baseURL: (_window$donationsSett = window.donationsSettings.baseURL) !== null && _window$donationsSett !== void 0 ? _window$donationsSett : '',
            isInitialized: true
          });
        });
      }
  ...
  if (!apiToken) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: className
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Please set an API Token on the plugin settings page.', 'donations'))));
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...(0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.useBlockProps)()
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Select a form', 'donations'),
    value: formId,
    options: forms ? forms : [{
      label: '',
      value: ''
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Title', 'donations'),
    value: title,
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Description', 'donations'),
    value: description,
    onChange: description => setAttributes({
      description
    }),
    disabled: !isLoaded
  }), !isLoaded && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Loading...', 'donations')), error && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, 'Error: ' + error)));
}
